        ...
        <div className="flex-1 p-6 flex flex-col justify-between">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center space-x-2 rtl:space-x-reverse px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-600 focus-visible:outline-none dark:focus-visible:ring-offset-gray-800"
    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={handleAddToCart}
            className="p-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-600 focus-visible:outline-none dark:focus-visible:ring-offset-gray-800"
            aria-label={t.product.addToCart}
            title={t.product.addToCart}
          >
            <ShoppingCart className="w-4 h-4" />
